import { Paper, Typography, Box, Chip, Stack, Link, Tooltip } from '@mui/material';
    ...
    >
      <Box>
        <Stack direction="row" justifyContent="space-between" alignItems="flex-start" mb={1}>
          ...
          <Tooltip title="View on GitHub">
            <GitHubIcon className="project-icon" fontSize="small" sx={{ transition: '0.2s', color: 'text.secondary' }} />
          </Tooltip>
        </Stack>
      ...
      <Box>
        <Stack direction="row" spacing={1} flexWrap="wrap" useFlexGap mb={2}>
          {repo.language && <Chip label={repo.language} size="small" color="primary" sx={{ fontWeight: 600 }} />}
